...
final solicitudNotifierProvider =
    StateNotifierProvider<DetalleSolicitudNotifier, DetalleSolicitudState>((
      ref,
    ) {
      final solicitudRepository = ref.watch(solicitudRepositoryProvider);
      return DetalleSolicitudNotifier(solicitudRepository);
    });
...
class DetalleSolicitudNotifier extends StateNotifier<DetalleSolicitudState> {
  ...
  DetalleSolicitudNotifier(this.solicitudRepository)
