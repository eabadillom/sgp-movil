...
class _ListarIncidenciasState extends ConsumerState<ListarIncidenciasScreen> {
  ...
  late void Function() _removeFechaIniListener;
  late void Function() _removeFechaFinListener;
  late void Function() _removeEstatusListener;
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      // ✅ Escuchar cambios manualmente con ref.listenManual
  ...
  void initState() {
    ...
    if (tipo == 'PE') {
      nombrePantalla = 'Permisos';
    }

    if (tipo == 'V') {
      nombrePantalla = 'Vacaciones';
    }
              ...
              if (incidenciasState.isLoading)
                ...
                Expanded(
                  child: ListaTarjetaGenerica<Incidencia>(
                    ...
                    getRoute: (incidencia) => '',
                    /*'/detalle/${registro.id}/${registro.codigoRegistro}'*/
                    // Ruta personalizada
                  ),
                ),
            ],
